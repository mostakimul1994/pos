                ...
                <table class="table table-condensed table-bordered blue-header variation_value_table">
                    ...
                    <tr>
                        ...
                        <td class="drag-select">
                          ...
                          $variation->default_sell_price, ['class' => 'form-control input-sm variable_dsp', 'min' => '0', 'placeholder' => 'Excluding tax']); !!}
                          {!! Form::number('product_variation[' . $loop->parent->index . '][variations][' . $loop->index . '][sell_price_inc_tax]',
                          $variation->sell_price_inc_tax, ['class' => 'form-control input-sm variable_dsp_inc_tax', 'min' => '0', 'placeholder' => 'Including tax']); !!}
                        </td>
