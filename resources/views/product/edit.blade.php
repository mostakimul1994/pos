      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="pull-right">
            <button type="submit" @if(empty($product->enable_stock)) disabled="true" @endif id="opening_stock_button"  value="update_n_edit_opening_stock" class="btn btn-success submit_product_form">@lang('lang_v1.update_n_edit_opening_stock')</button>&nbsp;&nbsp;
