                            ...
                            foreach ($rows as $key => $v) {
                                ...
                                if ($qty > 0) {
                                    ...
                                    if (isset($v['purchase_line_id'])) {
                                        ...
                                        $this->productUtil->updateProductQuantity($location_id, $product->id, $k, $qty, $purchase_line->quantity);
                                    } else {
                                        ...
                                        $this->productUtil->updateProductQuantity($location_id, $product->id, $k, $qty);
                                    }
