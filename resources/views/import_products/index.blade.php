                ...
                <div class="box-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>@lang('lang_v1.applicable_tax_ins') @lang('lang_v1.applicable_tax_help')</td>
                        </tr>
                        <tr>
                            <td>13</td>
                            <td>@lang('product.selling_price_tax_type') <small class="text-muted">(@lang('product.selling_price_tax_type'))</small></td>
                        ...
                        <tr>
                            ...
                            <td>@lang('lang_v1.expiry_date_ins')<br>
                            </td>
                        </tr>
                        <tr>
                            <td>24</td>
